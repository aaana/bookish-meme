...
|1|Client保存所有收到的消息到messageRecords下以account为文件名的log文件中|用户100和101登陆系统互相发送消息，100收到的所有消息保存在100.log中，101收到的所有消息保存在101.log中|与预期一致|通过|2016.05.30|通过
|2|Server保存所有收到的消息到messageRecords下的server.log文件中|用户100和101登陆进系统，并发送消息|server.log中记录服务端收到的所有消息|与预期一致|通过|2016.05.30|无
