...
//        fileEncryptAndDecrypt1.encrypt("./messageRecords/100.log","./messageRecords/100_加密.log");
        ...
        fileEncryptAndDecrypt1.encrypt("./messageRecords/100.log","./messageRecords/100加密.log",key);
        fileEncryptAndDecrypt1.decrypt("./messageRecords/100加密.log","./messageRecords/100解密.log",key);
    }
